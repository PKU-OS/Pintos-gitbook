...
* **Your cache should be **_<mark style="color:red;">**write-behind**</mark>_**, that is, keep dirty** blocks in the cache, instead of immediately writing modified data to disk.
...
**We recommend integrating the cache into your design \_early**\_**.**
