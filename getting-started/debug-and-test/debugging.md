...
* <mark style="color:blue;">**Macro: PRINTF\_FORMAT**</mark> <mark style="color:blue;"></mark><mark style="color:blue;"></mark> _<mark style="color:blue;">**(format, first)**</mark>_
...
* Second, **open a second terminal on the same machine (or in the same container, see below)**&#x20;
...
and issue the following GDB macro command:

```
debugpintos
```

<mark style="color:red;">**The GDB macro**</mark> <mark style="color:red;"></mark><mark style="color:red;"></mark> <mark style="color:red;">**`debugpintos`**</mark> <mark style="color:red;">**is provided as a shorthand for**</mark> <mark style="color:red;">**`target remote localhost:1234`**</mark><mark style="color:red;">**, so you can type this shorter command (**</mark><mark style="color:red;">**`debugpintos`**</mark><mark style="color:red;">**) instead.**</mark>

* Now GDB is connected to the gdb session in your first terminal over a local network connection. **You can now issue any normal GDB commands.**
  * If you issue the "c" (continue) command, the simulated Qemu in your first terminal will take control, load Pintos, and then Pintos will run in the usual way. You can pause the process at any point with `Ctrl+C`.
...
* <mark style="color:blue;">**GDB Macro:**</mark> <mark style="color:blue;">**btthreadall**</mark>
